	...
	var _handleFormSignin = function() {
		...
		FormValidation
		        ...
		        form,
		        {
		            fields: {
						username: {
							validators: {
								notEmpty: {
									message: 'يجب كتابة البريد الإلكتروني/رقم الجوال'
								}
							}
						},
						password: {
		    ...
		    .on('core.form.valid', function() {
				...
				KTUtil.btnWait(formSubmitButton, _buttonSpinnerClasses, "فضلاً انتظر");
			...
			.on('core.form.invalid', function() {
				Swal.fire({
					text: "يجب كتابة بيانات الدخول بشكل صحيح",
					icon: "error",
					buttonsStyling: false,
