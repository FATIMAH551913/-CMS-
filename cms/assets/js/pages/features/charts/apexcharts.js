...
var KTApexChartsDemo = function () {
	...
	var _demo2 = function () {
		...
		var options = {
			series: [{
				name: 'كراسات الشروط',
				data: [3100, 4000, 2008, 5010, 4232, 1091, 1024, 1002, 2023, 2002]
			}, {
				name: 'الدورات التدريبية',
				data: [1100, 3230, 4395, 3822, 3294, 5221, 4143, 1020, 2500, 1000]
			}],
			chart: {
				height: 350,
				type: 'area'
			...
			xaxis: {
				type: 'datetime',
				categories: ["2020-10-01", "2020-10-02", "2020-10-03", "2020-10-04", "2020-10-05", "2020-10-06", "2020-10-07", "2020-10-08", "2020-10-09", "2020-10-10"]
			},
			tooltip: {
				x: {
					format: 'dd/MM/yyyy'
