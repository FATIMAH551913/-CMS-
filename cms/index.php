                    ...
                    <div class="login-form text-center p-7 position-relative overflow-hidden">
                        ...
                        <div class="login-signin">
                            ...
                            <?php if (isset($_GET['error_msg']) && !empty($_GET['error_msg'])) { ?> 
                             <div> خطآ في بيانات الدخول </div> <?php } ?>
                            <form class="form" action="dashboard.php" method="post" id="kt_login_signin_form">
                                <div class="form-group mb-5">
                                    <input class="form-control h-auto form-control-solid py-4 px-8" value="" type="text" placeholder="اسم المستخدم" id="username" name="username" autocomplete="off" style="direction:rtl; important!" />
                                </div>
                                <div class="form-group mb-5">
                                    <input class="form-control h-auto form-control-solid py-4 px-8" value="" type="password" placeholder="كلمة المرور" id="password" name="password" style="direction:rtl; important!" />
                                </div>
